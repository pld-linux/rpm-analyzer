...
rpm-analyzer udostępnia graficzny interfejs pozwalający oglądać
zależności pakietów RPM zgodnie z lokalną lub zdefiniowaną przez
użytkownika konfiguracją rpm-a. To narzędzie jest oparte o hdlist i
może wymagać do niektórych opcji pliku comps.xml, więc warto rozważyć
